...
#if defined(_MM_SHUFFLE)
#undef USE_SSE_SUPPORT
#define USE_SSE_SUPPORT
#endif

#if defined(_m_empty) || defined(USE_SSE_SUPPORT)
#undef USE_MMX_DECODES
...
#define copy_si128(vd, vs) memcpy(vd, vs, 16);
#endif
...
extern void (*fbwrite_func[4])(
    UINT32, UINT32, UINT32, UINT32, UINT32, UINT32, UINT32);
extern void (*fbfill_func[4])(UINT32);
